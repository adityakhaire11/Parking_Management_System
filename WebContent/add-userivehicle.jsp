...
<body>
	<%
	//first if - whether user has already logged in or not
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							...
							<h6><span>Parking slot is full, Wait for sometimes.</span></h6>
							<%
								}
							%>
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-9">
										<input type="text" id="ownercontno" name="ownercontno"
											...
											required maxlength="10" value="<%=session.getAttribute("mobileNo")%>" readonly>
									</div>
								</div>
